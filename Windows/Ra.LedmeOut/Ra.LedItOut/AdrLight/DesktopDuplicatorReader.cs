...
using Polly;
using System.Linq;
using LedItOut.DesktopDuplication;
...
namespace LedItOut
{
    public class DesktopDuplicatorReader
    {
        ...
        public delegate void  FrameReadyDelegate();
        ...
        public static unsafe void GetAverageColorOfRectangularRegion(
            Rectangle spotRectangle, int stepy, int stepx, BitmapData bitmapData, out int sumR, out int sumG,
