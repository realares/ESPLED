...
namespace LedItOut
{
    ...
    public sealed class Spot : IDisposable
    {
        ...
        public Spot(int spotx, int spoty, int x, int y, int aWidth, int aHeight)
        {
            this.SpotsX = spotx;
            this.SpotsY = spoty;
        ...
        public int SpotsY { get; set; }
        public int SpotsX { get; set; }
        ...
        {
            Changed = Changed || (Red != red || Green != green || Blue != blue);
            Red = red;
            Green = green;
            Blue = blue;
